...
if (!BACKEND_URI) throw new Error("BACKEND_URI is missing in .env");


export { JWT_SECRET, MONGO_ATLAS_URI, EMAIL_USER, EMAIL_PASS, TWITTER_CONSUMER_KEY, TWITTER_CONSUMER_SECRET, FRONTEND_URI, BACKEND_URI };
